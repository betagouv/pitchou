 ...
 * en prenant data/demarche-numerique/schema-DS/7f52a348-fd16-4fcd-8a6f-2e78ddafaee4.json comme source
 *
 * Ne pas le modifier à la main
 *
 * À la place, mettre à jour data/demarche-numerique/schema-DS/7f52a348-fd16-4fcd-8a6f-2e78ddafaee4.json
...
export interface DossierDemarcheNumerique128114 {
  ...
  "Dans quel département se localise majoritairement votre projet ?": GeoAPIDepartement;
  /**
  ...
  "Département(s) où se situe le projet": GeoAPIDepartement[];
