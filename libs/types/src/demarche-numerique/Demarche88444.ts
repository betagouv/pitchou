 ...
 * en prenant data/demarche-numerique/schema-DS/derogation-especes-protegees.json comme source
 *
 * Ne pas le modifier à la main
 *
 * À la place, mettre à jour data/demarche-numerique/schema-DS/derogation-especes-protegees.json
