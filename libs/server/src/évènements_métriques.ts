...
import type {
  ÉvènementAjouterPieceJointeDétails,
  ÉvènementMétrique,
  ÉvènementOuvrirModaleAjouterPieceJointeDétails,
...
function estOuvertureModaleAjouterPieceJointeDétails(
  détails: any,
): détails is ÉvènementOuvrirModaleAjouterPieceJointeDétails {
  return (
...
function estAjouterPieceJointeDétails(détails: any): détails is ÉvènementAjouterPieceJointeDétails {
  return (
    Object(détails) === détails &&
    Number.isInteger(détails.dossierId) &&
    sourcesOuvertureModaleAjouterPieceJointe.has(détails.source) &&
...
export function évènementMétriqueGuard(évènement: any): évènement is ÉvènementMétrique {
  ...
  switch (type) {
    ...
    case "ouvrirModaleAjouterPieceJointe": {
      return estOuvertureModaleAjouterPieceJointeDétails(évènement.détails);
    }
    case "ajouterPieceJointe": {
      return estAjouterPieceJointeDétails(évènement.détails);
    }
