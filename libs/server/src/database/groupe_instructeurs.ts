...
} from "./groupe_instructeurs/groups.ts";
import {
...
} from "./groupe_instructeurs/members.ts";
import { createInstructeurCapsAndCompleteInstructeurIds } from "./groupe_instructeurs/caps.ts";
