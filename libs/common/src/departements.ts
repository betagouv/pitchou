/**
 * Official list of French departements (mainland, overseas and special codes),
 * identified by their INSEE code and name.
 *
 * Dossiers store the departement code (e.g. "88", "2A", "971", "99" for foreign locations).
 */
...
export const departements: Departement[] = [
  ...
  { code: "99", name: "Étranger" },
];

/** Departement name by INSEE code */
