## Page d'accueil - Tableau de suivi instruction DDEP

- **Navigation via onglets**

  Étapes :

  1. Cliquer sur un onglet (_Tableau de suivi_, _Saisie espèces protégées_, _Préremplissage dérogation_, _Aide Pitchou_).
...
- **Accès à un dossier**
  ...
  1. Cliquer sur _Voir le dossier_.
...
- **Suivre un dossier**
  ...
  1. Cliquer sur _Suivre_ sur un dossier.
...
- **Ne plus suivre un dossier**
  ...
  1. Cliquer sur _Ne plus suivre_.
