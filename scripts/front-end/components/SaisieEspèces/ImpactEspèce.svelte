    ...
    <div class="fr-col-md-5 fr-col-12 input-select">
      ...
      <div class="input-button-avec-bouton-supprimer">
        <select
          ...
          onchange={réinitialiserDétailsImpact}
          class="fr-select"
          id="input-espece-{indexEspèce}-impact-{indexImpact}"
        >
        ...
        {#if onSupprimerImpact}
          ...
          >
            <span class="fr-sr-only"
              >Supprimer l'impact #{indexImpact} sur l'espèce #{indexEspèce}</span
            >
          </button>
        {/if}
      </div>
    ...
    {#if impact.activité && impact.activité["Méthode"] === "Oui"}
      <div class="fr-col-md-4 fr-col-12 input-select">
        ...
        <select
          ...
          class="fr-select"
          id="input-espece-{indexEspèce}-methode-{indexImpact}"
        >
          <option value={undefined}>-</option>
    ...
    {#if impact.activité && impact.activité["Moyen de poursuite"] === "Oui"}
      <div class="fr-col-md-3 fr-col-12 input-select">
        ...
        <select
          ...
          class="fr-select"
          id="input-espece-{indexEspèce}-moyen-de-poursuite-{indexImpact}"
        >
          <option value={undefined}>-</option>
    ...
    <div class="fr-fieldset__element fr-input-group fr-grid-row fr-grid-row--gutters">
      {#if impact.activité["Nombre d'individus"] === "Oui"}
        <div class="fr-col-md-3 fr-col-12 input-select">
          ...
          <select
            ...
            class="fr-select"
            id="input-espece-{indexEspèce}-nombre-individus-{indexImpact}"
          >
            <option value={undefined}>-</option>
      ...
      {#if impact.activité["Nids"] === "Oui"}
        <div class="fr-col-md-3 fr-col-12 input-button">
          <label class="fr-label" for="input-espece-{indexEspèce}-nids-{indexImpact}"> Nids </label>
          <input
            type="number"
            ...
            step="1"
            class="fr-input"
            id="input-espece-{indexEspèce}-nids-{indexImpact}"
          />
        </div>
      {/if}
      ...
      {#if impact.activité["Œufs"] === "Oui"}
        <div class="fr-col-md-3 fr-col-12 input-button">
          ...
          <input
            ...
            step="1"
            class="fr-input"
            id="input-espece-{indexEspèce}-oeufs-{indexImpact}"
          />
        </div>
      {/if}
      ...
      {#if impact.activité["Surface habitat détruit (m²)"] === "Oui"}
        <div class="fr-col-md-3 fr-col-12 input-button">
          ...
          <input
            ...
            step="1"
            class="fr-input"
            id="input-espece-{indexEspèce}-surface-{indexImpact}"
          />
        </div>
      {/if}
    </div>
