<script>
  ...
  async function onFileInput(e) {
    ...
    if (file) {
      ...
      créerPrescriptionContrôlesÀPartirDeFichier(
  ...
  function sauvegarderDécisionAdministrative() {
    ...
    if (!décisionAdministrativeEnModification) {
      throw new TypeError(
        `décisionAdministrativeEnModification est undefined dans sauvegarderDécisionAdministrative`,
      );
    }
    ...
    décisionAdministrative = Object.assign(
      décisionAdministrative,
      décisionAdministrativeEnModification,
    );
...
<section class="décision-administrative">
  {#if !décisionAdministrativeEnModification}
    <h4>
      ...
      <button
        ...
        onclick={passerEnVueModifierDécisionAdministrative}
      >
        Modifier
      </button>
    </h4>
    ...
    <section class="prescriptions">
      {#if prescriptions.size === 0}
        ...
        <section class="fr-mb-3w">
          <p>
            Il n'y a pas de prescriptions associées à cette décision administrative pour le moment
          </p>
        ...
        <section class="fr-mb-4w">
          ...
          <div class="fr-upload-group">
            <label class="fr-label" for="file-upload">
              ...
              >. Il est important de garder les noms de colonnes (mais pas forcément l'ordre et
      ...
      {:else}
        ...
        {#if vuePrescription === "consulter"}
          {#each prescriptions as prescription}
            <Prescription
              {prescription}
              refreshDossierComplet={() => refreshDossierComplet(dossierId)}
            ></Prescription>
          {/each}
              ...
              {#each prescriptions as prescription}
                ...
                >
                  ...
                  <td
                    ><input
                      class="fr-input"
                      bind:value={prescription.surface_compensée}
                      type="number"
                      min="0"
                    /></td
                  >
                  <td
                    ><input
                      class="fr-input"
                      bind:value={prescription.surface_évitée}
                      type="number"
                      min="0"
                    /></td
                  >
                  <td
                    ><input
                      class="fr-input"
                      bind:value={prescription.individus_compensés}
                      type="number"
                      min="0"
                    /></td
                  >
                  <td
                    ><input
                      class="fr-input"
                      bind:value={prescription.individus_évités}
                      type="number"
                      min="0"
                    /></td
                  >
                  <td
                    ><input
                      class="fr-input"
                      bind:value={prescription.nids_compensés}
                      type="number"
                      min="0"
                    /></td
                  >
                  <td
                    ><input
                      class="fr-input"
                      bind:value={prescription.nids_évités}
                      type="number"
                      min="0"
                    /></td
                  >
  ...
  {:else}
    <!-- there is a décisionAdministrativeEnModification -->
    <h4>Modifier décision administrative</h4>

    <FormulaireDécisionAdministrative
      décisionAdministrative={décisionAdministrativeEnModification || {}}
      onValider={sauvegarderDécisionAdministrative}
    >
      {#snippet boutonValider()}
        <button type="submit" class="fr-btn">Sauvegarder</button>
      {/snippet}
      {#snippet boutonAnnuler()}
        <button type="button" class="fr-btn fr-btn--secondary" onclick={annulerModification}
          >Annuler</button
        >
      {/snippet}
      {#snippet boutonSupprimer()}
        <button
          ...
          onclick={supprimerDécisionAdministrative}
        >
