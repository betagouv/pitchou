 ...
 * @property { {activités: ParClassification<Map<ActivitéMenançante['Code'], ActivitéMenançante>>, méthodes: ParClassification<Map<MéthodeMenançante['Code'], MéthodeMenançante>>, transports: ParClassification<Map<TransportMenançant['Code'], TransportMenançant>>, nomenclatureActivitésPitchou: Map<ActivitéMenançante['Code'], ActivitéMenançante> } } [activitésMéthodesTransports]
