...
/** @import {ParClassification, ActivitéMenançante, EspèceProtégée, MéthodeMenançante, TransportMenançant, DonnéesSecondaires} from '../types/especes.d.ts' */
 ...
 * @property { {activités: ParClassification<Map<ActivitéMenançante['Identifiant Pitchou'], ActivitéMenançante>>, méthodes: ParClassification<Map<MéthodeMenançante['Code'], MéthodeMenançante>>, transports: ParClassification<Map<TransportMenançant['Code'], TransportMenançant>>, activitéVersDonnéesSecondaires: Map<ActivitéMenançante['Identifiant Pitchou'], DonnéesSecondaires[]> } } [activitésMéthodesTransports]
