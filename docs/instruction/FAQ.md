...
- **Est-ce que Pitchou va remplacer Onagre ?**
  Oui.
  Les deux fonctions incontournables d’onagre sont de : - récupérer les données nécessaires au rapportage européen et saisir le CNPN. Dans la mesure où on remplace le CERFA papier par DN, notre objectif est de récupérer les données numériquement directement et de pouvoir produire le rapportage européen. - L’objectif est de passer aussi par DN pour la saisine du CNPN.
