      ...
      return knex.schema
        ...
        .then(() => {
          ...
          return knex("dossier").update({
            enjeu_écologique: knex.raw(
              `CASE WHEN enjeu_écologiques IS NULL OR enjeu_écologiques = 'false' THEN false ELSE true END`,
            ),
          });
        })
        .then(function () {
