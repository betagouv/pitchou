...
import { isValidPhone, validateCreationCore } from "./dossierCreationCoreValidation.ts";
import { validateCreationScientific } from "./dossierCreationScientificValidation.ts";
