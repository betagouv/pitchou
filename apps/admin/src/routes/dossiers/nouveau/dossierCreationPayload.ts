...
import { buildCreationColumns } from "./dossierCreationPayloadColumns.ts";
import type { DossierCreationModel } from "./dossierCreationState.ts";
import { activiteDetailKind, showsRequestContext } from "./dossierCreationVisibility.ts";
