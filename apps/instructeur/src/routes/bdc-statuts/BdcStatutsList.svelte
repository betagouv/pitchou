<script lang="ts">
  ...
  import BdcStatutsResults from "./BdcStatutsResults.svelte";
  import BdcStatutsSearchControls from "./BdcStatutsSearchControls.svelte";
...
<BdcStatutsResults {rows} {loading} {erreur} />
