<script lang="ts">
  import { SORT_OPTIONS, type SortKey, type SortOrder } from "./bdcStatutsList.ts";
...
>
  <legend class="text-[1.25rem] fr-text--bold fr-mb-2w fr-p-0">Trier les statuts</legend>
  <div
    class="flex flex-row flex-wrap items-center gap-2"
    role="group"
    aria-label="Trier les statuts"
  >
