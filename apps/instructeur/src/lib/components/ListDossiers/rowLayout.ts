...
export const TILE_GRID =
  "flex flex-col gap-3 lg:grid lg:grid-cols-[2.5rem_3rem_minmax(8rem,1.5fr)_minmax(8rem,1.3fr)_minmax(10.5rem,1.1fr)_minmax(7rem,1fr)_minmax(6.5rem,0.9fr)_4.5rem] lg:items-start lg:gap-x-4 lg:gap-y-0";
