...
<div class="rounded-lg focus-within:[outline:2px_solid_#0a76f6] focus-within:[outline-offset:2px]">
  ...
  <div
    bind:this={element}
    class="rounded-b-lg border border-t-0 border-solid border-[var(--border-default-grey)] bg-white text-[#161616] [color-scheme:light] [&_.tiptap]:min-h-[16rem] [&_.tiptap]:p-4 [&_.tiptap]:text-[0.9375rem] [&_.tiptap]:leading-6 [&_.tiptap]:outline-none [&_.tiptap_ul]:list-disc [&_.tiptap_ol]:list-decimal [&_.tiptap_ul]:pl-6 [&_.tiptap_ol]:pl-6 [&_.tiptap_blockquote]:border-l-4 [&_.tiptap_blockquote]:border-solid [&_.tiptap_blockquote]:border-gray-300 [&_.tiptap_blockquote]:pl-4 [&_.tiptap_table]:w-full [&_.tiptap_table]:border-collapse [&_.tiptap_table]:fr-my-2w [&_.tiptap_th]:border [&_.tiptap_th]:border-solid [&_.tiptap_th]:border-[#ddd] [&_.tiptap_th]:bg-[#f6f6f6] [&_.tiptap_th]:px-3 [&_.tiptap_th]:py-2 [&_.tiptap_td]:border [&_.tiptap_td]:border-solid [&_.tiptap_td]:border-[#ddd] [&_.tiptap_td]:px-3 [&_.tiptap_td]:py-2"
  ></div>
</div>
