...
function decision(
  overrides: Partial<FrontEndDécisionAdministrative> = {},
  ...
  return reactive({
    ...
    numéro: "AP-001",
    ...overrides,
  } as FrontEndDécisionAdministrative);
}

function renderInModifyMode(supprimerDécisionAdministrative: () => Promise<unknown>) {
